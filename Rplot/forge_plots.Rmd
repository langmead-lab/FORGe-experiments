...
indiv <- read_forge('../results/chr9_NA12878_ref.tsv', 'Individualized', 'Standard')
indiv$Num <- indiv$Pct
...
indiv <- read_forge('../results/chr9_NA12878_ref_erg.tsv', 'Individualized', 'Standard')
indiv$Num <- indiv$Pct
