...
mv ordered.txt ordered_popcov25.txt
...
mv ordered.txt ordered_popcov_blowup25.txt

$VIS_HOME/rank.py --method amb --reference hs37d5.fa --vars snps.1ksnp --chrom $CHR --window-size 25 --phasing haplotypes.txt
mv ordered.txt ordered_amb25.txt
mv ordered.txt.blowup ordered_amb_blowup25.txt
