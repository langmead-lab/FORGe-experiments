...
if PLOT_POP_COV:
    popcov = read_tsv('../results/chr9_all_bowtie_popcov_l25.tsv')
    popcov_mem = read_mem('../results/chr' + chrom + '_all_popcov_mem_erg.tsv')
...
if PLOT_POP_COV_COMBINED:
    popcov_blowup = read_tsv('../results/chr9_all_bowtie_popcov_blowup_l25.tsv')
    popcov_blowup_mem = read_mem('../results/chr' + chrom + '_all_popcov_blowup_mem_erg.tsv')
...
if PLOT_AMB:
    amb = read_tsv('../results/chr9_all_bowtie_amb_l25.tsv')
    amb_mem = read_mem('../results/chr' + chrom + '_all_amb_mem_erg.tsv')
...
if PLOT_AMB_COMBINED:
    amb_blowup = read_tsv('../results/chr9_all_bowtie_amb_blowup_l25.tsv')
    amb_blowup_mem = read_mem('../results/chr' + chrom + '_all_amb_blowup_mem_erg.tsv')
...
plt.savefig('chr' + chrom + '_hisat_align_mem.png', bbox_inches='tight')
plt.clf()
exit()
'''
...
plt.savefig('chr' + chrom + '_erg_vs_mem.png', bbox_inches='tight')
plt.clf()
